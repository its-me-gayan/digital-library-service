...
public interface LibraryOperationService {
  ResponseEntity<ApiResponse<BorrowBookResponseDto>> borrowBook(BorrowBookRequestDto bookRequestDto)
      throws BookException;

  ResponseEntity<ApiResponse<ReturnBookResponseDto>> returnBook(
