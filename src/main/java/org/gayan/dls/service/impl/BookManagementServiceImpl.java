...
public class BookManagementServiceImpl implements BookManagementService {
    ...
    @Transactional
    @Override
    public ResponseEntity<ApiResponse<BookResponseDto>> persistBook(BookRequestDto bookRequestDto) throws BookException {
        ...
        if (Objects.nonNull(validatedBook)) {
            ...
            log.info("Book updated with one more copy :: {}, total copy :: {}",
                    createdOrUpdateBook.getId(), validatedBook.getCopies().size());
        ...
        return responseBuilder
                .success(bookMapper.mapBookEntityToBookResponseDto(createdOrUpdateBook) , responseMessage );
    }
