...
/** Author: Gayan Sanjeewa User: gayan Date: 9/20/25 Time: 9:43 PM */
@ControllerAdvice
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ApiResponse<Object>> handleLibraryOperationException(
      LibraryOperationException ex) {
    return responseBuilder.error(ex.getHttpStatus(), ex.getMessage());
  }

  @ExceptionHandler(NoContentFoundException.class)
  public ResponseEntity<ApiResponse<Object>> handleNoContentFoundException(
      NoContentFoundException ex) {
